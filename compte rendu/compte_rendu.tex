...
%faire la conclusion
%virer la police moche de [T1]{fontenc} ( je comprend pas pourquoi tu dit que ça fait des erreurs quand on l'enlève : ça me fait pas d erreurs quand je le vire )
...
Introduisons quelques notations qui seront utilisées par la suNous introduisons dans cette section les notations utilisés dans tout le rapport.\\
