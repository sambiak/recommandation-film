...
Cependant, si l'on efface toutes les notes connues de notre tableau de départ, il est évident que l'algorithme ne pourra pas fonctionner.
...
Au final, nous avons trouvé un taux d'erreur optimal pour n = 10, alpha_X = 0.000125, alpha_theta = 0.0001, nb_etapes \in [900,950. Le taux d'erreur vaut alors environ 0.79.
...
sur la factorisation de matrice, et la descente du gradient.\\ \\ \\ \\ \\ \\
 % bon c'est un peu degueu comme résumé mais c compliquer de résumer un projet en 5 lignes, bref help please
